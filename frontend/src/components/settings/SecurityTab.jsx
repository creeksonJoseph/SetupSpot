...
export const SecurityTab = ({
  ...
  return (
    <div className="max-w-md">
      ...
      {pwdSuccess && (
        <div
          className="mb-5 p-3 rounded-xl border text-xs font-medium inline-flex items-center gap-2"
          style={{
      ...
      {pwdStep === 1 && (
        <form onSubmit={handleRequestChangeOtp} className="space-y-4">
          <div
            className="p-3 rounded-xl border text-xs leading-relaxed inline-block"
      ...
      {pwdStep === 2 && (
        <form onSubmit={handleVerifyOtp} className="space-y-4">
          <div
            className="p-3 rounded-xl border text-xs font-medium inline-block"
            style={{
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="000000"
              className="w-56 px-4 py-2.5 rounded-xl tracking-[0.5em] text-center font-mono text-lg outline-none transition-all border block"
