      ...
      <div className="mx-auto max-w-7xl">
        ...
        {activeTab === 'profile' && (
          <form onSubmit={handleSaveProfile} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white  border p-6 md:p-8 shadow-sm flex flex-col items-center text-center justify-between" style={{ borderColor: '#E2E8F0' }}>
              <div className="flex flex-col items-center text-center w-full">
                <label className="block text-xs font-bold uppercase tracking-wider mb-6" style={{ color: '#0F172A' }}>
                  Profile Picture
                </label>

                <div className="relative group mb-6">
                  <div
                    className="w-32 h-32 rounded-full border-4 shadow-lg overflow-hidden flex items-center justify-center text-white text-4xl font-black"
                    style={{
                      borderColor: '#ffffff',
                ...
                <h3 className="font-extrabold text-lg" style={{ color: '#0F172A' }}>
                ...
                <div className="w-full pt-6 mt-6 border-t" style={{ borderColor: '#E2E8F0' }}>
                  <label
                    htmlFor="avatar-file-input"
                    className="cursor-pointer w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border text-sm font-semibold transition-all hover:bg-slate-200 shadow-sm"
                  ...
                  />
                  <p className="text-xs mt-2" style={{ color: '#727687' }}>
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl border p-6 md:p-8 shadow-sm flex flex-col justify-between" style={{ borderColor: '#E2E8F0' }}>
              ...
              {/* Submit Button */}
              <div className="pt-6 mt-6 border-t flex justify-end" style={{ borderColor: '#E2E8F0' }}>
                <button
                  type="submit"
