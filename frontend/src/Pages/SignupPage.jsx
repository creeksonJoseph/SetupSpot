  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-violet-600/15 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-gray-900/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-gray-400 text-sm mb-8">Share your setup with the world</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            {/* Username */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="signup-username" className="text-gray-300 text-sm font-medium">
                Username
              </label>
              <input
                id="signup-username"
