  ...
  >
    ...
    <div className={`p-4 rounded-2xl shadow-sm border flex flex-col h-full overflow-hidden ${cardBg}`}>
      <div className="flex justify-between items-center pb-3 shrink-0">
        <input
          ...
          placeholder="Setup Title (e.g. Minimalist Minimal Desk Setup)"
    ...
    <div className={`p-4 rounded-2xl shadow-sm border flex flex-col h-full overflow-hidden ${cardBg}`}>
      <div className="flex-1 overflow-y-auto">
        {!selectedAnnotation ? (
          <div className="h-full flex flex-col items-center justify-center p-4 text-center rounded-xl border-2 border-dashed border-slate-200 bg-slate-50/50">
      ...
      <div className="pt-3 mt-3 border-t shrink-0 space-y-3" style={{ borderColor: "#E2E8F0" }}>
        {apiMessage.text && (
          <div
        ...
        <button
          ...
          className="w-full py-2.5 rounded-xl font-bold text-xs text-white transition-all flex items-center justify-center gap-2 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
          style={{ backgroundColor: "#0066ff" }}
          onMouseEnter={(e) => {
